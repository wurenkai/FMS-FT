...
parser = argparse.ArgumentParser(description='FT_FMF')
parser.add_argument('--model', default='FT_FMF', help='select a model structure', choices=__models__.keys())
parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')

parser.add_argument('--dataset', default='kitti', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--datapath_15', default=r"", help='data path')
parser.add_argument('--trainlist', default='./filenames/SCARED_train.txt', help='training list')
parser.add_argument('--testlist',default='./filenames/SCARED_test.txt', help='testing list')
...
train_dataset = StereoDataset(args.datapath_15, args.trainlist, True)
